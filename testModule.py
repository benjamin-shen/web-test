...
def update_csv(name,testChoice,questionNumber,score): # update students csv file    
    # read csv file
    source = open("/home/students/2018/benjamin.shen/public_html/project/students/"+testChoice,'rU')
    csv = source.read()
    source.close()
    # change values
    ...
    # write to csv file
    dest = open("/home/students/2018/benjamin.shen/public_html/project/students/"+testChoice,'w',0)
